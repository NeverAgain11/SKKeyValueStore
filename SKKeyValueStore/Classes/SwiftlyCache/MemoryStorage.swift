...
class MemoryStorage {
    ...
    /**
     ...
     @param node:缓存对象
     */
    func insertNodeAtHead(node: LinkedNode) {
    ...
    func removeObject(node: LinkedNode) {
